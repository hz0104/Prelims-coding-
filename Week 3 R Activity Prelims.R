...
sex_column <- HaotingTitanic$Sex
age_column <- HaotingTitanic$Age
...
subset_data <- subset(HaotingTitanic, Freq > 25)
...
ggplot(HaotingTitanic, aes(x = Survived, y = Freq)) +
  geom_col()
